                ...
                <div class="header d-flex justify-content-between align-items-center">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 me-4">
                            ...
                            <li class="breadcrumb-item active text-dark" aria-current="page">Tambah Data Administrator</li>
                        </ol>
                    </nav>
                </div>
            </div>
            <div class="col-6 mx-3 mt-2 container-fluid">
                <form class="card px-2" method="POST" action="{{ route('admin.store') }}" enctype="multipart/form-data">
                    @csrf
