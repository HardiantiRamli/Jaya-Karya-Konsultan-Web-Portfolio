                ...
                <div class="header d-flex justify-content-between align-items-center">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 me-4">
                            ...
                            <li class="breadcrumb-item active text-dark" aria-current="page">Tambah Data Blog Edukasi</li>
                        </ol>
                    </nav>
                </div>
            </div>
            <div class="col-6 mx-3 mt-2 container-fluid">
                <form class="card px-2" method="POST" action="{{ route('blog.update', ['id' => $data->id]) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="wrapper border-radius-2xl px-2 py-1">
                        <div class="input">
                            <div class="input-group input-group-static my-3">
                                ...
                                <input type="text" class="form-control" name="author" value="{{ $data->user->name }}">
                                <br>
                                @error('author')
                                    <small>{{ $message }}</small>
                                @enderror
                        ...
                        <div class="input">
                            <div class="input-group input-group-static my-3">
                                ...
                                <input type="text" class="form-control" name="judul_blog" value="{{ $data->judul_blog }}">
                                <br>
                                @error('judul_blog')
                                    <small>{{ $message }}</small>
                                @enderror
                        ...
                        <div class="input">
                            <div class="input-group input-group-static my-3">
                                ...
                                <textarea name="isi_blog" id="isi-blog" class="form-control" cols="30" rows="10" placeholder="Isi Blog .....">
                                    {{ $data->isi_blog }}
                                </textarea>
                                @error('isi_blog')
                                    <small>{{ $message }}</small>
                        ...
                        <div class="input">
                            <div class="d-flex flex-column my-3">
                                ...
                                <img src="{{ asset('storage/img-blog/' . $data->img) }}" alt="galeri_foto">
                                @error('img')
                                    <small>{{ $message }}</small>
                                @enderror
                            </div>
