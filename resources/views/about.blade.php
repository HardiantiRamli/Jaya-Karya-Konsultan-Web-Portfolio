...
<head>
    ...
    <meta name="description" content="Lihat profil usaha CV. Jaya Karya Konsultan sebagai konsultan bangunan profesional di Blitar dan sekitarnya.">
    ...
    <meta name="dcterms.title" content="Profil | Cv. Jaya Karya Konsultan">
    <meta name="dcterms.description" content="Lihat profil usaha CV. Jaya Karya Konsultan sebagai konsultan bangunan profesional di Blitar dan sekitarnya.">
    <meta name="dcterms.rights" content="CV. Jaya Karya Konsultan 2025">
    <meta property="og:locale" content="id_ID">
    <meta property="og:title" content="Profil | Cv. Jaya Karya Konsultan">
    <meta property="og:description" content="Lihat profil usaha CV. Jaya Karya Konsultan sebagai konsultan bangunan profesional di Blitar dan sekitarnya.">
    <meta property="og:url" content="https://www.jayakaryakonsultan.com/about">
    ...
    <title>Profil | Cv. Jaya Karya Konsultan</title>
    @vite('resources/css/app.css')
    <link rel="canonical" href="https://www.jayakaryakonsultan.com/about" />
...
<body>
    ...
    <main class="relative h-auto py-12 px-6 bg-gray-50 overflow-hidden" aria-label="Layanan Kami">
        ...
        <div class="relative z-30">
            <h2 class="md:text-2xl text-lg text-blue-600 text-center font-semibold">Tentang Perusahaan</h2>
        </div>

        <div class="deskripsi bg-white shadow-lg rounded-lg p-6 mt-6 max-w-4xl mx-auto relative z-30">
            <h2 class="text-xl font-bold text-gray-800 border-l-4 border-blue-600 pl-3 mb-3">Deskripsi Perusahaan</h2>
            <p class="text-gray-700 text-justify leading-relaxed">
                {{ $data->deskripsi }}
            </p>
        </div>

        <div class="visi-misi bg-white shadow-lg rounded-lg p-6 mt-6 max-w-4xl mx-auto relative z-30">
            <h2 class="text-xl font-bold text-gray-800 border-l-4 border-blue-600 pl-3 mb-3">Visi & Misi</h2>
            <p class="text-gray-700 text-justify leading-relaxed">
                {!! nl2br(e($data->visi_misi)) !!}
            </p>
        </div>
    </main>
