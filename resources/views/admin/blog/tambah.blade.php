    ...
    <div class="container-fluid py-2">
        <div class="row">
            ...
            <div class="col-6 mx-3 mt-2 container-fluid">
                <form class="card px-2" method="POST" action="{{ route('blog.store') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="wrapper border-radius-2xl px-2 py-1">
                        ...
                        <div class="input">
                            <div class="input-group input-group-static my-3">
                                ...
                                <textarea name="isi_blog" id="isi-blog" class="form-control" cols="30" rows="10" placeholder="Isi Blog ....."></textarea>
                                @error('isi_blog')
                                    <small>{{ $message }}</small>
                                @enderror
                            </div>
